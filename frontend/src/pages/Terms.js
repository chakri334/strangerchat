    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white pb-20">
      ...
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-8">
        ...
        {[
          ...
          { title: "3. Anonymous Chat", body: "Stumble Chat connects you with random strangers anonymously. You use a display name of your choice. We do not verify identities. You are solely responsible for the information you share during chats. Do not share your real name, phone number, address, or financial information with strangers." },
          ...
          { title: "6. Reporting", body: "If another user violates these terms, use the in-app Report feature. Reports include the conversation history for review. Users reported 3 or more times may be temporarily blocked from the platform. False or malicious reports are also a violation of these terms." },
          { title: "7. Disclaimer of Warranties", body: "Stumble Chat is provided 'as is' without warranties of any kind. We do not guarantee uninterrupted service, the accuracy of information shared by users, or the safety of interactions. Use the platform at your own risk." },
          { title: "8. Limitation of Liability", body: "To the fullest extent permitted by law, Stumble Chat and its operators shall not be liable for any indirect, incidental, or consequential damages arising from your use of the App, including harm caused by other users." },
          { title: "9. Changes to Terms", body: "We may update these Terms at any time. Continued use of the App after changes are posted constitutes acceptance of the new terms. We will indicate the 'Last updated' date at the top of this page." },
          { title: "10. Contact", body: "For questions about these Terms, contact us at stumblechat.online@gmail.com." },
        ].map(({ title, body }) => (
          <div key={title}>
